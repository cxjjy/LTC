...
export const contractDirectionOptions: SelectOption[] = [
  { value: "SALES", label: "销售合同（客户-我方）" },
  { value: "PURCHASE", label: "采购合同（我方-供应商）" }
];
...
export function buildContractFields(projectOptions: SelectOption[], supplierOptions: SelectOption[] = []): EntityFormField<CreateContractDto>[] {
  return [
    {
      name: "projectId",
      label: "项目",
    ...
    { name: "direction", label: "合同方向", type: "select", options: contractDirectionOptions },
    {
      name: "supplierId",
      label: "供应商",
      type: "select",
      options: supplierOptions,
      requestUrl: "/api/options/suppliers"
    },
